...
public class HttpConnectionUtil {
    ...
    public static JSONObject payVbankRequst(HashMap< String, String> pList, String param_url) throws ParseException {

        String myResult = "";

        try {
            //   URL 설정하고 접속하기
            URL url = new URL(param_url); // URL 설정
            ...
            myResult = builder.toString();
            return CommonUtil.stringToJson(myResult);
