...
<nav class="navbar navbar-inverse main-color">
    <div class="container main-color">
        ...
        <div id="navbar" class="navbar-collapse collapse main-color">
            <ul class="nav navbar-nav">
                <c:if test="${data.USE_YN1 == 'Y'}"><li><a href="#">${data.TITLE1}</a></li></c:if>
                <c:if test="${data.USE_YN2 == 'Y'}"><li><a href="#">${data.TITLE2}</a></li></c:if>
                <c:if test="${data.USE_YN3 == 'Y'}"><li><a href="#">${data.TITLE3}</a></li></c:if>
                <c:if test="${data.USE_YN4 == 'Y'}"><li><a href="#">${data.TITLE4}</a></li></c:if>
                <c:if test="${data.USE_YN5 == 'Y'}"><li><a href="#">${data.TITLE5}</a></li></c:if>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
    ...
    <!-- 모바일 전화하기 영역 -->
    <a href="tel:${data.CONNECT_TEL}" class="mob_tel">
