...
<div id="appCapsule">
            ...
            <div class="splide__track">
                <ul class="splide__list">
                    <li class="splide__slide">
                        <div class="card">
                            <img src="/resources/admin/mob/img/sample/photo/d1.jpg" class="card-img-top" alt="image">
                    ...
                    <li class="splide__slide">
                        <div class="card">
                            <img src="/resources/admin/mob/img/sample/photo/d2.jpg" class="card-img-top" alt="image">
                            <div class="card-body pt-2">
                    ...
                    <li class="splide__slide">
                        <div class="card">
                            <img src="/resources/admin/mob/img/sample/photo/d3.jpg" class="card-img-top" alt="image">
                            <div class="card-body pt-2">
                    ...
                    <li class="splide__slide">
                        <div class="card">
                            <img src="/resources/admin/mob/img/sample/photo/d4.jpg" class="card-img-top" alt="image">
                            <div class="card-body pt-2">
                    ...
                    <li class="splide__slide">
                        <div class="card">
                            <img src="/resources/admin/mob/img/sample/photo/d6.jpg" class="card-img-top" alt="image">
                            <div class="card-body pt-2">
                    ...
                    <li class="splide__slide">
                        <div class="card">
                            <img src="/resources/admin/mob/img/sample/photo/d7.jpg" class="card-img-top" alt="image">
                            <div class="card-body pt-2">
                    ...
                    <li class="splide__slide">
                        <div class="card">
                            <img src="/resources/admin/mob/img/sample/photo/d5.jpg" class="card-img-top" alt="image">
                            <div class="card-body pt-2">
    ...
    <div class="section mt-3 mb-3">
        <div class="card">
            <img src="/resources/admin/mob/img/sample/photo/wide4.jpg" class="card-img-top" alt="image">
            <div class="card-body">
                <h6 class="card-subtitle">Discover</h6>
    ...
    <div class="section mt-3 mb-3">
        <div class="card">
            <img src="/resources/admin/mob/img/sample/photo/wide2.jpg" class="card-img-top" alt="image">
            <div class="card-body">
                <h6 class="card-subtitle">Discover</h6>
